# Calibrated Binary Classification (WDBC): Technical Analysis Report

**Project:** Ensemble Benchmarking, Probability Calibration, and Decision-Policy Tuning on the Wisconsin Diagnostic Breast Cancer Dataset  
